...
import {
  Container, Row, Col, Button, Card, CardHeader, CardBody, Modal,
  ModalHeader, ModalBody, ModalFooter, Input, Form, FormGroup, Label, CardTitle
} from 'reactstrap';
                        ...
                        <CardBody>
                          ...
                          <Row>
                            <Col md={4}>
                              ...
                              <Col md={12}>
                                <Col md={5}>
                                  <AvField name="Amount" label="จำนวน" type="select" errorMessage="กรุณากรอกจำนวนที่ต้องการ" bsSize="sm" validate={{
                                    required: { value: true }
                                  }}><option></option>
                                    <option>1</option>
                                    <option>2</option>
                            ...
                            <Col md={4}>
                              ...
                              <Col md={12}>
                                <Col md={5}>
                                  <AvField name="Amount2" label="จำนวน" type="select" errorMessage="กรุณากรอกจำนวนที่ต้องการ" bsSize="sm" validate={{
                                    required: { value: true }
                                  }}><option></option>
                                    <option>1</option>
                                    <option>2</option>
